...
export const SelectTrigger = React.forwardRef<HTMLButtonElement, SelectTriggerProps>(
  function SelectTrigger(props, ref) {
    const { children, clearable, border, onClear, ...rest } = props
    return (
      <ChakraSelect.Control {...rest}>
        <ChakraSelect.Trigger ref={ref} border={border}>
          {children}
        </ChakraSelect.Trigger>
        <ChakraSelect.IndicatorGroup>
          {clearable && <SelectClearTrigger onClear={onClear} />}
...
const SelectClearTrigger = React.forwardRef<HTMLButtonElement, ClearTriggerProps>(
