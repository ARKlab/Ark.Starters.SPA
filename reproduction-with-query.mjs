...
// This time simulating an active query before reset
...
// Start a query to have active state
console.log('Starting a query...');
const promise = store.dispatch(api.endpoints.getTodos.initiate());

// Wait a bit for the query to be in progress
await new Promise(resolve => setTimeout(resolve, 100));

console.log('Query state:', store.getState()[api.reducerPath]);

// Try to dispatch the reset action while query is active
